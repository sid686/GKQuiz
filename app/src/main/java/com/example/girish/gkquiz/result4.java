...
public class result4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sharebody = "I scored: " + finalscore + " in Test 4, I am challenging you to beat my Score. Download this General Knowledge Quiz app now.";
    ...
    public void initControls(){
        ...
        int q1answer = app_preferences.getInt("answer_31", 0);
        int q2answer = app_preferences.getInt("answer_32", 0);
        int q3answer = app_preferences.getInt("answer_33",0);
        int q4answer = app_preferences.getInt("answer_34",0);
        int q5answer = app_preferences.getInt("answer_35",0);
        int q6answer = app_preferences.getInt("answer_36",0);
        int q7answer = app_preferences.getInt("answer_37",0);
        int q8answer = app_preferences.getInt("answer_38",0);
        int q9answer = app_preferences.getInt("answer_39",0);
        int q10answer = app_preferences.getInt("answer_40",0);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(result4.this, category.class);
    ...
    public void level5(){
        ...
        SharedPreferences.Editor edit= sharedPreferences.edit();
        edit.putBoolean("fifthlevel", true);
        edit.apply();
    ...
    public void alertbox(){
        ...
        final Dialog dialog = new Dialog(result4.this);
