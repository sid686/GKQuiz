...
public class result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sharebody = "I scored: " + finalscore + " in Test 1, I am challenging you to beat my Score. Download this General Knowledge Quiz app now.";
    ...
    public void initControls(){
        ...
        int q2answer = app_preferences.getInt("answer_valuee", 0);
        int q3answer = app_preferences.getInt("answer_third",0);
        int q4answer = app_preferences.getInt("answer_fourth",0);
        int q5answer = app_preferences.getInt("answer_fifth",0);
        int q6answer = app_preferences.getInt("answer_sixth",0);
        int q7answer = app_preferences.getInt("answer_seventh",0);
        int q8answer = app_preferences.getInt("answer_eighth",0);
        int q9answer = app_preferences.getInt("answer_ninth",0);
        int q10answer = app_preferences.getInt("answer_tenth",0);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(result.this, category.class);
    ...
    public void level2(){
        ...
        SharedPreferences.Editor edit= sharedPreferences.edit();
        edit.putBoolean("secondlevel", true);
        edit.apply();
