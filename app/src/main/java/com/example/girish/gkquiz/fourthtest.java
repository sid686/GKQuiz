...
public class fourthtest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Test 4");
        fourthtestvisible();

        alert();
        getSharedPreferences("count3", 0).edit().clear().commit();
...

        {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(fourthtest.this, result4.class);
    ...
    Button.OnClickListener listener = new Button.OnClickListener() {
        @Override
        public void onClick(View v) {
            final SharedPreferences app_preferences = PreferenceManager.getDefaultSharedPreferences(fourthtest.this);
            SharedPreferences.Editor editor = app_preferences.edit();

            if (q1a1.isChecked()) {
                editor.putInt("answer_31", 1);
            }
            else if (q1a2.isChecked() || q1a3.isChecked() || q1a4.isChecked()){


                editor.putInt("answer_31", 2);
            }



            if (q2a1.isChecked()) {
                editor.putInt("answer_32", 1);
            }

            else if (q2a2.isChecked() || q2a3.isChecked() || q2a4.isChecked()){


                editor.putInt("answer_32", 2);
            }
            if (q3a2.isChecked()) {
                editor.putInt("answer_33", 1);
            }

            else if (q3a1.isChecked() || q3a3.isChecked() || q3a4.isChecked()){


                editor.putInt("answer_33", 2);
            }


            if (q4a3.isChecked()) {
                editor.putInt("answer_34", 1);
            }

            else if (q4a2.isChecked() || q4a1.isChecked() || q4a4.isChecked()){


                editor.putInt("answer_34", 2);
            }
            if (q5a1.isChecked()) {
                editor.putInt("answer_35", 1);
            }

            else if (q5a2.isChecked() || q5a3.isChecked() || q5a4.isChecked()){


                editor.putInt("answer_35", 2);
            }


            if (q6a3.isChecked()) {
                editor.putInt("answer_36", 1);
            }

            else if (q6a2.isChecked() || q6a1.isChecked() || q6a4.isChecked()){


                editor.putInt("answer_36", 2);
            }

            if (q7a2.isChecked()) {
                editor.putInt("answer_37", 1);
            }

            else if (q7a1.isChecked() || q7a3.isChecked() || q7a4.isChecked()){


                editor.putInt("answer_37", 2);
            }


            if (q8a3.isChecked()) {
                editor.putInt("answer_38", 1);
            }

            else if (q8a2.isChecked() || q8a1.isChecked() || q8a4.isChecked()){


                editor.putInt("answer_38", 2);
            }
            if (q9a1.isChecked()) {
                editor.putInt("answer_39", 1);
            }

            else if (q9a2.isChecked() || q9a3.isChecked() || q9a4.isChecked()){


                editor.putInt("answer_39", 2);
            }
            if (q10a4.isChecked()) {
                editor.putInt("answer_40", 1);
            }

            else if (q10a2.isChecked() || q10a3.isChecked() || q10a1.isChecked()){


                editor.putInt("answer_40", 2);
            }
    ...
    private void starttime() {
        countDownTimer = new CountDownTimer(timertime, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                SharedPreferences sharedPreferences = getSharedPreferences("count3", 0);
            ...
            public void onFinish() {
                Intent i = new Intent(fourthtest.this, result4.class);
                startActivity(i);
    ...
    public void alert() {
        ...
        builder.setMessage("You will get 3 minutes for this test and cutoff for this test is 9,Press OK to start Quiz")
                .setCancelable(false)
