...
public class result3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sharebody = "I scored: " + finalscore + " in Test 3, I am challenging you to beat my Score. Download this General Knowledge Quiz app now.";
    ...
    public void initControls(){
        ...
        int q1answer = app_preferences.getInt("answer_21", 0);
        int q2answer = app_preferences.getInt("answer_22", 0);
        int q3answer = app_preferences.getInt("answer_23",0);
        int q4answer = app_preferences.getInt("answer_24",0);
        int q5answer = app_preferences.getInt("answer_25",0);
        int q6answer = app_preferences.getInt("answer_26",0);
        int q7answer = app_preferences.getInt("answer_27",0);
        int q8answer = app_preferences.getInt("answer_28",0);
        int q9answer = app_preferences.getInt("answer_29",0);
        int q10answer = app_preferences.getInt("answer_30",0);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(result3.this, category.class);
    ...
    public void level4(){
        ...
        SharedPreferences.Editor edit= sharedPreferences.edit();
        edit.putBoolean("fourthlevel", true);
        edit.apply();
    ...
    public void alertbox(){
        ...
        final Dialog dialog = new Dialog(result3.this);
