...
public class secondtest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert();
        getSharedPreferences("count1", 0).edit().clear().commit();

    q1a2 =(RadioButton)

    findViewById(R.id.q1a2);

    q1a1 =(RadioButton)

    findViewById(R.id.q1a1);

    q1a3 =(RadioButton)

    findViewById(R.id.q1a3);

    q1a4 =(RadioButton)

    findViewById(R.id.q1a4);

    q2a1 =(RadioButton)

    findViewById(R.id.q2a1);

    q2a2 =(RadioButton)

    findViewById(R.id.q2a2);

    q2a3 =(RadioButton)

    findViewById(R.id.q2a3);

    q2a4 =(RadioButton)

    findViewById(R.id.q2a4);

    q3a1 =(RadioButton)

    findViewById(R.id.q3a1);

    q3a2 =(RadioButton)

    findViewById(R.id.q3a2);

    q3a3 =(RadioButton)

    findViewById(R.id.q3a3);

    q3a4 =(RadioButton)

    findViewById(R.id.q3a4);

    q4a1 =(RadioButton)

    findViewById(R.id.q4a1);

    q4a2 =(RadioButton)

    findViewById(R.id.q4a2);

    q4a3 =(RadioButton)

    findViewById(R.id.q4a3);

    q4a4 =(RadioButton)

    findViewById(R.id.q4a4);

    q5a1 =(RadioButton)

    findViewById(R.id.q5a1);

    q5a2 =(RadioButton)

    findViewById(R.id.q5a2);

    q5a3 =(RadioButton)

    findViewById(R.id.q5a3);

    q5a4 =(RadioButton)

    findViewById(R.id.q5a4);

    q6a1 =(RadioButton)

    findViewById(R.id.q6a1);

    q6a2 =(RadioButton)

    findViewById(R.id.q6a2);

    q6a3 =(RadioButton)

    findViewById(R.id.q6a3);

    q6a4 =(RadioButton)

    findViewById(R.id.q6a4);

    q7a1 =(RadioButton)

    findViewById(R.id.q7a1);

    q7a2 =(RadioButton)

    findViewById(R.id.q7a2);

    q7a3 =(RadioButton)

    findViewById(R.id.q7a3);

    q7a4 =(RadioButton)

    findViewById(R.id.q7a4);

    q8a1 =(RadioButton)

    findViewById(R.id.q8a1);

    q8a2 =(RadioButton)

    findViewById(R.id.q8a2);

    q8a3 =(RadioButton)

    findViewById(R.id.q8a3);

    q8a4 =(RadioButton)

    findViewById(R.id.q8a4);

    q9a1 =(RadioButton)

    findViewById(R.id.q9a1);

    q9a2 =(RadioButton)

    findViewById(R.id.q9a2);

    q9a3 =(RadioButton)

    findViewById(R.id.q9a3);

    q9a4 =(RadioButton)

    findViewById(R.id.q9a4);

    q10a1 =(RadioButton)

    findViewById(R.id.q10a1);

    q10a2 =(RadioButton)

    findViewById(R.id.q10a2);

    q10a3 =(RadioButton)

    findViewById(R.id.q10a3);

    q10a4 =(RadioButton)

    findViewById(R.id.q10a4);
...

    {
        ...
        Intent intent = new Intent(secondtest.this, result2.class);
    ...
    Button.OnClickListener listener = new Button.OnClickListener(){
        @Override
        public void onClick(View v){
            final SharedPreferences app_preferences = PreferenceManager.getDefaultSharedPreferences(secondtest.this);
            SharedPreferences.Editor editor = app_preferences.edit();

            if (q1a1.isChecked()){
                editor.putInt("answer_11", 1);
            }

            else if (q1a2.isChecked() || q1a3.isChecked() || q1a4.isChecked()){


                editor.putInt("answer_11", 2);
            }


            if (q2a2.isChecked()){
                editor.putInt("answer_12", 1);
            }

            else if (q2a1.isChecked() || q2a3.isChecked() || q2a4.isChecked()){


                editor.putInt("answer_12", 2);
            }
            if (q3a3.isChecked()){
                editor.putInt("answer_13", 1);
            }
            else if (q3a2.isChecked() || q3a1.isChecked() || q3a4.isChecked()){


                editor.putInt("answer_13", 2);
            }


            if (q4a2.isChecked()){
                editor.putInt("answer_14", 1);
            }

            else if (q4a1.isChecked() || q4a3.isChecked() || q4a4.isChecked()){


                editor.putInt("answer_14", 2);
            }
            if (q5a3.isChecked()){
                editor.putInt("answer_15", 1);
            }

            else if (q5a2.isChecked() || q5a1.isChecked() || q5a4.isChecked()){


                editor.putInt("answer_15", 2);
            }


            if (q6a3.isChecked()){
                editor.putInt("answer_16", 1);
            }

            else if (q6a2.isChecked() || q6a1.isChecked() || q6a4.isChecked()){


                editor.putInt("answer_16", 2);
            }
            if (q7a2.isChecked()){
                editor.putInt("answer_17", 1);
            }

            else if (q7a1.isChecked() || q7a3.isChecked() || q7a4.isChecked()){


                editor.putInt("answer_17", 2);
            }


            if (q8a3.isChecked()){
                editor.putInt("answer_18", 1);
            }

            else if (q8a2.isChecked() || q8a1.isChecked() || q8a4.isChecked()){


                editor.putInt("answer_18", 2);
            }


            if (q9a3.isChecked()){
                editor.putInt("answer_19", 1);
            }

            else if (q9a2.isChecked() || q9a1.isChecked() || q9a4.isChecked()){


                editor.putInt("answer_19", 2);
            }


            if (q10a1.isChecked()){
                editor.putInt("answer_20", 1);
            }

            else if (q10a2.isChecked() || q10a3.isChecked() || q10a4.isChecked()){


                editor.putInt("answer_20", 2);
            }
    ...
    private void starttime(){
        countDownTimer = new CountDownTimer(timertime, 1000) {
            ...
            public void onFinish() {
                Intent i = new Intent(secondtest.this, result2.class);
                startActivity(i);
    ...
    public void alert(){
        ...
        builder.setMessage("You will get 7 minutes for this test and cutoff for this test is 7,Press OK to start Quiz")
                .setCancelable(false)
